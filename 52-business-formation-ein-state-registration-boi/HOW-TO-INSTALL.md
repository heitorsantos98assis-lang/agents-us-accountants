# 52-business-formation-ein-state-registration-boi — Codex Agent
...
cp 52-business-formation-ein-state-registration-boi.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 52-business-formation-ein-state-registration-boi.md
# OR
...
```bash
rm .codex/agents/52-business-formation-ein-state-registration-boi.md
# OR
rm .codex/agents/52-business-formation-ein-state-registration-boi.md
```
