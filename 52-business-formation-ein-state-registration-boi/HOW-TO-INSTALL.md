# 52-business-formation-ein-state-registration-boi — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `52-business-formation-ein-state-registration-boi.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 52-business-formation-ein-state-registration-boi.zip
```
...
cp 52-business-formation-ein-state-registration-boi.md .claude/agents/
...
```
Use the business-formation-ein-state-registration-boi subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 52-business-formation-ein-state-registration-boi.md
# OR
...
```bash
rm .claude/agents/52-business-formation-ein-state-registration-boi.md
# OR
rm ~/.claude/agents/52-business-formation-ein-state-registration-boi.md
```
