# 07-annual-federal-return-prep-1120-1065-1120s — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `07-annual-federal-return-prep-1120-1065-1120s.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 07-annual-federal-return-prep-1120-1065-1120s.zip
```
...
cp 07-annual-federal-return-prep-1120-1065-1120s.md .claude/agents/
...
```
Use the annual-federal-return-prep-1120-1065-1120s subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 07-annual-federal-return-prep-1120-1065-1120s.md
# OR
...
```bash
rm .claude/agents/07-annual-federal-return-prep-1120-1065-1120s.md
# OR
rm ~/.claude/agents/07-annual-federal-return-prep-1120-1065-1120s.md
```
