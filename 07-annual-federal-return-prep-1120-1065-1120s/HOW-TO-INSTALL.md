# 07-annual-federal-return-prep-1120-1065-1120s — Codex Agent
...
cp 07-annual-federal-return-prep-1120-1065-1120s.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 07-annual-federal-return-prep-1120-1065-1120s.md
# OR
...
```bash
rm .codex/agents/07-annual-federal-return-prep-1120-1065-1120s.md
# OR
rm .codex/agents/07-annual-federal-return-prep-1120-1065-1120s.md
```
