# 43-fixed-assets-depreciation-macrs-section-179-bonus — Codex Agent
...
cp 43-fixed-assets-depreciation-macrs-section-179-bonus.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 43-fixed-assets-depreciation-macrs-section-179-bonus.md
# OR
...
```bash
rm .codex/agents/43-fixed-assets-depreciation-macrs-section-179-bonus.md
# OR
rm .codex/agents/43-fixed-assets-depreciation-macrs-section-179-bonus.md
```
