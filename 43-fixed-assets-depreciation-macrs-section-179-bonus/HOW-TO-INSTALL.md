# 43-fixed-assets-depreciation-macrs-section-179-bonus — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `43-fixed-assets-depreciation-macrs-section-179-bonus.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 43-fixed-assets-depreciation-macrs-section-179-bonus.zip
```
...
cp 43-fixed-assets-depreciation-macrs-section-179-bonus.md .claude/agents/
...
```
Use the fixed-assets-depreciation-macrs-section-179-bonus subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 43-fixed-assets-depreciation-macrs-section-179-bonus.md
# OR
...
```bash
rm .claude/agents/43-fixed-assets-depreciation-macrs-section-179-bonus.md
# OR
rm ~/.claude/agents/43-fixed-assets-depreciation-macrs-section-179-bonus.md
```
