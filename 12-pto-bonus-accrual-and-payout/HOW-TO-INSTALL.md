# 12-pto-bonus-accrual-and-payout — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `12-pto-bonus-accrual-and-payout.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 12-pto-bonus-accrual-and-payout.zip
```
...
cp 12-pto-bonus-accrual-and-payout.md .claude/agents/
...
```
Use the pto-bonus-accrual-and-payout subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 12-pto-bonus-accrual-and-payout.md
# OR
...
```bash
rm .claude/agents/12-pto-bonus-accrual-and-payout.md
# OR
rm ~/.claude/agents/12-pto-bonus-accrual-and-payout.md
```
