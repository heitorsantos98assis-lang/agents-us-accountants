# 12-pto-bonus-accrual-and-payout — Codex Agent
...
cp 12-pto-bonus-accrual-and-payout.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 12-pto-bonus-accrual-and-payout.md
# OR
...
```bash
rm .codex/agents/12-pto-bonus-accrual-and-payout.md
# OR
rm .codex/agents/12-pto-bonus-accrual-and-payout.md
```
