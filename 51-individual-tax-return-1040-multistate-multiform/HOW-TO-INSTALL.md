# 51-individual-tax-return-1040-multistate-multiform — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `51-individual-tax-return-1040-multistate-multiform.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 51-individual-tax-return-1040-multistate-multiform.zip
```
...
cp 51-individual-tax-return-1040-multistate-multiform.md .claude/agents/
...
```
Use the individual-tax-return-1040-multistate-multiform subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 51-individual-tax-return-1040-multistate-multiform.md
# OR
...
```bash
rm .claude/agents/51-individual-tax-return-1040-multistate-multiform.md
# OR
rm ~/.claude/agents/51-individual-tax-return-1040-multistate-multiform.md
```
