# 57-tcja-sunset-2026-tax-legislation-planning — Codex Agent
...
cp 57-tcja-sunset-2026-tax-legislation-planning.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 57-tcja-sunset-2026-tax-legislation-planning.md
# OR
...
```bash
rm .codex/agents/57-tcja-sunset-2026-tax-legislation-planning.md
# OR
rm .codex/agents/57-tcja-sunset-2026-tax-legislation-planning.md
```
