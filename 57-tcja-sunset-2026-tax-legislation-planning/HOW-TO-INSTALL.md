# 57-tcja-sunset-2026-tax-legislation-planning — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `57-tcja-sunset-2026-tax-legislation-planning.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 57-tcja-sunset-2026-tax-legislation-planning.zip
```
...
cp 57-tcja-sunset-2026-tax-legislation-planning.md .claude/agents/
...
```
Use the tcja-sunset-2026-tax-legislation-planning subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 57-tcja-sunset-2026-tax-legislation-planning.md
# OR
...
```bash
rm .claude/agents/57-tcja-sunset-2026-tax-legislation-planning.md
# OR
rm ~/.claude/agents/57-tcja-sunset-2026-tax-legislation-planning.md
```
