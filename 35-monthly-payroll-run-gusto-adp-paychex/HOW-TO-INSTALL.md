# 35-monthly-payroll-run-gusto-adp-paychex — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `35-monthly-payroll-run-gusto-adp-paychex.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 35-monthly-payroll-run-gusto-adp-paychex.zip
```
...
cp 35-monthly-payroll-run-gusto-adp-paychex.md .claude/agents/
...
```
Use the monthly-payroll-run-gusto-adp-paychex subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 35-monthly-payroll-run-gusto-adp-paychex.md
# OR
...
```bash
rm .claude/agents/35-monthly-payroll-run-gusto-adp-paychex.md
# OR
rm ~/.claude/agents/35-monthly-payroll-run-gusto-adp-paychex.md
```
