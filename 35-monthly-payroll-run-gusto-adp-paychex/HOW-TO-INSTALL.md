# 35-monthly-payroll-run-gusto-adp-paychex — Codex Agent
...
cp 35-monthly-payroll-run-gusto-adp-paychex.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 35-monthly-payroll-run-gusto-adp-paychex.md
# OR
...
```bash
rm .codex/agents/35-monthly-payroll-run-gusto-adp-paychex.md
# OR
rm .codex/agents/35-monthly-payroll-run-gusto-adp-paychex.md
```
