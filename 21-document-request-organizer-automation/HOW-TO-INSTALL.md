# 21-document-request-organizer-automation — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `21-document-request-organizer-automation.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 21-document-request-organizer-automation.zip
```
...
cp 21-document-request-organizer-automation.md .claude/agents/
...
```
Use the document-request-organizer-automation subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 21-document-request-organizer-automation.md
# OR
...
```bash
rm .claude/agents/21-document-request-organizer-automation.md
# OR
rm ~/.claude/agents/21-document-request-organizer-automation.md
```
