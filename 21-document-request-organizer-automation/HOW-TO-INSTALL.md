# 21-document-request-organizer-automation — Codex Agent
...
cp 21-document-request-organizer-automation.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 21-document-request-organizer-automation.md
# OR
...
```bash
rm .codex/agents/21-document-request-organizer-automation.md
# OR
rm .codex/agents/21-document-request-organizer-automation.md
```
