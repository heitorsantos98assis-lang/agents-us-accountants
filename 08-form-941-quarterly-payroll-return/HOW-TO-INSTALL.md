# 08-form-941-quarterly-payroll-return — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `08-form-941-quarterly-payroll-return.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 08-form-941-quarterly-payroll-return.zip
```
...
cp 08-form-941-quarterly-payroll-return.md .claude/agents/
...
```
Use the form-941-quarterly-payroll-return subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 08-form-941-quarterly-payroll-return.md
# OR
...
```bash
rm .claude/agents/08-form-941-quarterly-payroll-return.md
# OR
rm ~/.claude/agents/08-form-941-quarterly-payroll-return.md
```
