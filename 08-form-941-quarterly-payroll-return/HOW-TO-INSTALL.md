# 08-form-941-quarterly-payroll-return — Codex Agent
...
cp 08-form-941-quarterly-payroll-return.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 08-form-941-quarterly-payroll-return.md
# OR
...
```bash
rm .codex/agents/08-form-941-quarterly-payroll-return.md
# OR
rm .codex/agents/08-form-941-quarterly-payroll-return.md
```
