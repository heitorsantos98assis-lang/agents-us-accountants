# 02-state-sales-use-tax-wayfair-nexus — Codex Agent
...
cp 02-state-sales-use-tax-wayfair-nexus.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 02-state-sales-use-tax-wayfair-nexus.md
# OR
...
```bash
rm .codex/agents/02-state-sales-use-tax-wayfair-nexus.md
# OR
rm .codex/agents/02-state-sales-use-tax-wayfair-nexus.md
```
