# 15-new-hire-onboarding-i9-w4-w9 — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `15-new-hire-onboarding-i9-w4-w9.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 15-new-hire-onboarding-i9-w4-w9.zip
```
...
cp 15-new-hire-onboarding-i9-w4-w9.md .claude/agents/
...
```
Use the new-hire-onboarding-i9-w4-w9 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 15-new-hire-onboarding-i9-w4-w9.md
# OR
...
```bash
rm .claude/agents/15-new-hire-onboarding-i9-w4-w9.md
# OR
rm ~/.claude/agents/15-new-hire-onboarding-i9-w4-w9.md
```
