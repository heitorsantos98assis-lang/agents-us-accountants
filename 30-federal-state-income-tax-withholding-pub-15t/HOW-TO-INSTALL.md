# 30-federal-state-income-tax-withholding-pub-15t — Codex Agent
...
cp 30-federal-state-income-tax-withholding-pub-15t.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 30-federal-state-income-tax-withholding-pub-15t.md
# OR
...
```bash
rm .codex/agents/30-federal-state-income-tax-withholding-pub-15t.md
# OR
rm .codex/agents/30-federal-state-income-tax-withholding-pub-15t.md
```
