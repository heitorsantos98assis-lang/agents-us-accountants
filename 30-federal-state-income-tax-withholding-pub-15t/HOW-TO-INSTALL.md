# 30-federal-state-income-tax-withholding-pub-15t — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `30-federal-state-income-tax-withholding-pub-15t.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 30-federal-state-income-tax-withholding-pub-15t.zip
```
...
cp 30-federal-state-income-tax-withholding-pub-15t.md .claude/agents/
...
```
Use the federal-state-income-tax-withholding-pub-15t subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 30-federal-state-income-tax-withholding-pub-15t.md
# OR
...
```bash
rm .claude/agents/30-federal-state-income-tax-withholding-pub-15t.md
# OR
rm ~/.claude/agents/30-federal-state-income-tax-withholding-pub-15t.md
```
