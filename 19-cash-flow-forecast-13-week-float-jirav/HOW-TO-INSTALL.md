# 19-cash-flow-forecast-13-week-float-jirav — Codex Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `19-cash-flow-forecast-13-week-float-jirav.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 19-cash-flow-forecast-13-week-float-jirav.zip
```
...
cp 19-cash-flow-forecast-13-week-float-jirav.md .codex/agents/
...
```
Use the cash-flow-forecast-13-week-float-jirav subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 19-cash-flow-forecast-13-week-float-jirav.md
# OR
...
```bash
rm .codex/agents/19-cash-flow-forecast-13-week-float-jirav.md
# OR
rm .codex/agents/19-cash-flow-forecast-13-week-float-jirav.md
```
