...
cp 19-cash-flow-forecast-13-week-float-jirav.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 19-cash-flow-forecast-13-week-float-jirav.md
# OR
...
```bash
rm .claude/agents/19-cash-flow-forecast-13-week-float-jirav.md
# OR
rm ~/.claude/agents/19-cash-flow-forecast-13-week-float-jirav.md
```
