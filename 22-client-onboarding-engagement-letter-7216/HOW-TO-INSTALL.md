# 22-client-onboarding-engagement-letter-7216 — Codex Agent
...
cp 22-client-onboarding-engagement-letter-7216.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 22-client-onboarding-engagement-letter-7216.md
# OR
...
```bash
rm .codex/agents/22-client-onboarding-engagement-letter-7216.md
# OR
rm .codex/agents/22-client-onboarding-engagement-letter-7216.md
```
