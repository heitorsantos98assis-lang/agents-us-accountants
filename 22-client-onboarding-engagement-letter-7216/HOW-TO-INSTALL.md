# 22-client-onboarding-engagement-letter-7216 — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `22-client-onboarding-engagement-letter-7216.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 22-client-onboarding-engagement-letter-7216.zip
```
...
cp 22-client-onboarding-engagement-letter-7216.md .claude/agents/
...
```
Use the client-onboarding-engagement-letter-7216 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 22-client-onboarding-engagement-letter-7216.md
# OR
...
```bash
rm .claude/agents/22-client-onboarding-engagement-letter-7216.md
# OR
rm ~/.claude/agents/22-client-onboarding-engagement-letter-7216.md
```
