# 13-final-paycheck-cobra-separation — Codex Agent
...
cp 13-final-paycheck-cobra-separation.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 13-final-paycheck-cobra-separation.md
# OR
...
```bash
rm .codex/agents/13-final-paycheck-cobra-separation.md
# OR
rm .codex/agents/13-final-paycheck-cobra-separation.md
```
