# 13-final-paycheck-cobra-separation — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `13-final-paycheck-cobra-separation.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 13-final-paycheck-cobra-separation.zip
```
...
cp 13-final-paycheck-cobra-separation.md .claude/agents/
...
```
Use the final-paycheck-cobra-separation subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 13-final-paycheck-cobra-separation.md
# OR
...
```bash
rm .claude/agents/13-final-paycheck-cobra-separation.md
# OR
rm ~/.claude/agents/13-final-paycheck-cobra-separation.md
```
