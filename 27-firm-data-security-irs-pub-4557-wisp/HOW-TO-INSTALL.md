# 27-firm-data-security-irs-pub-4557-wisp — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `27-firm-data-security-irs-pub-4557-wisp.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 27-firm-data-security-irs-pub-4557-wisp.zip
```
...
cp 27-firm-data-security-irs-pub-4557-wisp.md .claude/agents/
...
```
Use the firm-data-security-irs-pub-4557-wisp subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 27-firm-data-security-irs-pub-4557-wisp.md
# OR
...
```bash
rm .claude/agents/27-firm-data-security-irs-pub-4557-wisp.md
# OR
rm ~/.claude/agents/27-firm-data-security-irs-pub-4557-wisp.md
```
