# 27-firm-data-security-irs-pub-4557-wisp — Codex Agent
...
cp 27-firm-data-security-irs-pub-4557-wisp.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 27-firm-data-security-irs-pub-4557-wisp.md
# OR
...
```bash
rm .codex/agents/27-firm-data-security-irs-pub-4557-wisp.md
# OR
rm .codex/agents/27-firm-data-security-irs-pub-4557-wisp.md
```
