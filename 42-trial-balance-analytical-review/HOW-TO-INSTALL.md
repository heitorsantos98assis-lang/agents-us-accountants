# 42-trial-balance-analytical-review — Codex Agent
...
cp 42-trial-balance-analytical-review.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 42-trial-balance-analytical-review.md
# OR
...
```bash
rm .codex/agents/42-trial-balance-analytical-review.md
# OR
rm .codex/agents/42-trial-balance-analytical-review.md
```
