# 42-trial-balance-analytical-review — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `42-trial-balance-analytical-review.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 42-trial-balance-analytical-review.zip
```
...
cp 42-trial-balance-analytical-review.md .claude/agents/
...
```
Use the trial-balance-analytical-review subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 42-trial-balance-analytical-review.md
# OR
...
```bash
rm .claude/agents/42-trial-balance-analytical-review.md
# OR
rm ~/.claude/agents/42-trial-balance-analytical-review.md
```
