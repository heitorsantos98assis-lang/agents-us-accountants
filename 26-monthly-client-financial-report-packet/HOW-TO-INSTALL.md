# 26-monthly-client-financial-report-packet — Codex Agent
...
cp 26-monthly-client-financial-report-packet.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 26-monthly-client-financial-report-packet.md
# OR
...
```bash
rm .codex/agents/26-monthly-client-financial-report-packet.md
# OR
rm .codex/agents/26-monthly-client-financial-report-packet.md
```
