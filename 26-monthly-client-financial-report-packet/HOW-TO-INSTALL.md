# 26-monthly-client-financial-report-packet — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `26-monthly-client-financial-report-packet.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 26-monthly-client-financial-report-packet.zip
```
...
cp 26-monthly-client-financial-report-packet.md .claude/agents/
...
```
Use the monthly-client-financial-report-packet subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 26-monthly-client-financial-report-packet.md
# OR
...
```bash
rm .claude/agents/26-monthly-client-financial-report-packet.md
# OR
rm ~/.claude/agents/26-monthly-client-financial-report-packet.md
```
