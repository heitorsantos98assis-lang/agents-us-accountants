# 49-financial-due-diligence-quality-of-earnings-sell-side — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `49-financial-due-diligence-quality-of-earnings-sell-side.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 49-financial-due-diligence-quality-of-earnings-sell-side.zip
```
...
cp 49-financial-due-diligence-quality-of-earnings-sell-side.md .claude/agents/
...
```
Use the financial-due-diligence-quality-of-earnings-sell-side subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 49-financial-due-diligence-quality-of-earnings-sell-side.md
# OR
...
```bash
rm .claude/agents/49-financial-due-diligence-quality-of-earnings-sell-side.md
# OR
rm ~/.claude/agents/49-financial-due-diligence-quality-of-earnings-sell-side.md
```
