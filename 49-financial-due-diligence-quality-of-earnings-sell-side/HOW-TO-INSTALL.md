# 49-financial-due-diligence-quality-of-earnings-sell-side — Codex Agent
...
cp 49-financial-due-diligence-quality-of-earnings-sell-side.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 49-financial-due-diligence-quality-of-earnings-sell-side.md
# OR
...
```bash
rm .codex/agents/49-financial-due-diligence-quality-of-earnings-sell-side.md
# OR
rm .codex/agents/49-financial-due-diligence-quality-of-earnings-sell-side.md
```
