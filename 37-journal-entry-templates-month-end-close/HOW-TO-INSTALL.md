# 37-journal-entry-templates-month-end-close — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `37-journal-entry-templates-month-end-close.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 37-journal-entry-templates-month-end-close.zip
```
...
cp 37-journal-entry-templates-month-end-close.md .claude/agents/
...
```
Use the journal-entry-templates-month-end-close subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 37-journal-entry-templates-month-end-close.md
# OR
...
```bash
rm .claude/agents/37-journal-entry-templates-month-end-close.md
# OR
rm ~/.claude/agents/37-journal-entry-templates-month-end-close.md
```
