# 37-journal-entry-templates-month-end-close — Codex Agent
...
cp 37-journal-entry-templates-month-end-close.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 37-journal-entry-templates-month-end-close.md
# OR
...
```bash
rm .codex/agents/37-journal-entry-templates-month-end-close.md
# OR
rm .codex/agents/37-journal-entry-templates-month-end-close.md
```
