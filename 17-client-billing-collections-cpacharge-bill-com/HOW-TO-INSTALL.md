# 17-client-billing-collections-cpacharge-bill-com — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `17-client-billing-collections-cpacharge-bill-com.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 17-client-billing-collections-cpacharge-bill-com.zip
```
...
cp 17-client-billing-collections-cpacharge-bill-com.md .claude/agents/
...
```
Use the client-billing-collections-cpacharge-bill-com subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 17-client-billing-collections-cpacharge-bill-com.md
# OR
...
```bash
rm .claude/agents/17-client-billing-collections-cpacharge-bill-com.md
# OR
rm ~/.claude/agents/17-client-billing-collections-cpacharge-bill-com.md
```
