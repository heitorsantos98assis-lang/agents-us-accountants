# 41-month-end-close-checklist-cas — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `41-month-end-close-checklist-cas.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 41-month-end-close-checklist-cas.zip
```
...
cp 41-month-end-close-checklist-cas.md .claude/agents/
...
```
Use the month-end-close-checklist-cas subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 41-month-end-close-checklist-cas.md
# OR
...
```bash
rm .claude/agents/41-month-end-close-checklist-cas.md
# OR
rm ~/.claude/agents/41-month-end-close-checklist-cas.md
```
