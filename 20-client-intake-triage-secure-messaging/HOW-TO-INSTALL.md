# 20-client-intake-triage-secure-messaging — Codex Agent
...
cp 20-client-intake-triage-secure-messaging.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 20-client-intake-triage-secure-messaging.md
# OR
...
```bash
rm .codex/agents/20-client-intake-triage-secure-messaging.md
# OR
rm .codex/agents/20-client-intake-triage-secure-messaging.md
```
