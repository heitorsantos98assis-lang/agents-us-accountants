# 20-client-intake-triage-secure-messaging — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `20-client-intake-triage-secure-messaging.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 20-client-intake-triage-secure-messaging.zip
```
...
cp 20-client-intake-triage-secure-messaging.md .claude/agents/
...
```
Use the client-intake-triage-secure-messaging subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 20-client-intake-triage-secure-messaging.md
# OR
...
```bash
rm .claude/agents/20-client-intake-triage-secure-messaging.md
# OR
rm ~/.claude/agents/20-client-intake-triage-secure-messaging.md
```
