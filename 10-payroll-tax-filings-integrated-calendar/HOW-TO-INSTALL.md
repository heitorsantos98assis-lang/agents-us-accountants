# 10-payroll-tax-filings-integrated-calendar — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `10-payroll-tax-filings-integrated-calendar.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 10-payroll-tax-filings-integrated-calendar.zip
```
...
cp 10-payroll-tax-filings-integrated-calendar.md .claude/agents/
...
```
Use the payroll-tax-filings-integrated-calendar subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 10-payroll-tax-filings-integrated-calendar.md
# OR
...
```bash
rm .claude/agents/10-payroll-tax-filings-integrated-calendar.md
# OR
rm ~/.claude/agents/10-payroll-tax-filings-integrated-calendar.md
```
