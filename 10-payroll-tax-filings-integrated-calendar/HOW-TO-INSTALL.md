# 10-payroll-tax-filings-integrated-calendar — Codex Agent
...
cp 10-payroll-tax-filings-integrated-calendar.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 10-payroll-tax-filings-integrated-calendar.md
# OR
...
```bash
rm .codex/agents/10-payroll-tax-filings-integrated-calendar.md
# OR
rm .codex/agents/10-payroll-tax-filings-integrated-calendar.md
```
