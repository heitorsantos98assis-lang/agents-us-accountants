# 11-pay-stub-generation-review — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `11-pay-stub-generation-review.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 11-pay-stub-generation-review.zip
```
...
cp 11-pay-stub-generation-review.md .claude/agents/
...
```
Use the pay-stub-generation-review subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 11-pay-stub-generation-review.md
# OR
...
```bash
rm .claude/agents/11-pay-stub-generation-review.md
# OR
rm ~/.claude/agents/11-pay-stub-generation-review.md
```
