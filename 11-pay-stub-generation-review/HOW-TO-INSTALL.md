# 11-pay-stub-generation-review — Codex Agent
...
cp 11-pay-stub-generation-review.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 11-pay-stub-generation-review.md
# OR
...
```bash
rm .codex/agents/11-pay-stub-generation-review.md
# OR
rm .codex/agents/11-pay-stub-generation-review.md
```
