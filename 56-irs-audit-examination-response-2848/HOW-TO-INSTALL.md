# 56-irs-audit-examination-response-2848 — Codex Agent
...
cp 56-irs-audit-examination-response-2848.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 56-irs-audit-examination-response-2848.md
# OR
...
```bash
rm .codex/agents/56-irs-audit-examination-response-2848.md
# OR
rm .codex/agents/56-irs-audit-examination-response-2848.md
```
