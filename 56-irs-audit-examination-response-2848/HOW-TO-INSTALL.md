# 56-irs-audit-examination-response-2848 — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `56-irs-audit-examination-response-2848.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 56-irs-audit-examination-response-2848.zip
```
...
cp 56-irs-audit-examination-response-2848.md .claude/agents/
...
```
Use the irs-audit-examination-response-2848 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 56-irs-audit-examination-response-2848.md
# OR
...
```bash
rm .claude/agents/56-irs-audit-examination-response-2848.md
# OR
rm ~/.claude/agents/56-irs-audit-examination-response-2848.md
```
