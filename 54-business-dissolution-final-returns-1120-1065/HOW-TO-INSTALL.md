# 54-business-dissolution-final-returns-1120-1065 — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `54-business-dissolution-final-returns-1120-1065.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 54-business-dissolution-final-returns-1120-1065.zip
```
...
cp 54-business-dissolution-final-returns-1120-1065.md .claude/agents/
...
```
Use the business-dissolution-final-returns-1120-1065 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 54-business-dissolution-final-returns-1120-1065.md
# OR
...
```bash
rm .claude/agents/54-business-dissolution-final-returns-1120-1065.md
# OR
rm ~/.claude/agents/54-business-dissolution-final-returns-1120-1065.md
```
