# 39-ap-vendor-reconciliation-bill-com — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `39-ap-vendor-reconciliation-bill-com.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 39-ap-vendor-reconciliation-bill-com.zip
```
...
cp 39-ap-vendor-reconciliation-bill-com.md .claude/agents/
...
```
Use the ap-vendor-reconciliation-bill-com subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 39-ap-vendor-reconciliation-bill-com.md
# OR
...
```bash
rm .claude/agents/39-ap-vendor-reconciliation-bill-com.md
# OR
rm ~/.claude/agents/39-ap-vendor-reconciliation-bill-com.md
```
