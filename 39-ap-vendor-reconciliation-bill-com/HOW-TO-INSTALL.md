# 39-ap-vendor-reconciliation-bill-com — Codex Agent
...
cp 39-ap-vendor-reconciliation-bill-com.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 39-ap-vendor-reconciliation-bill-com.md
# OR
...
```bash
rm .codex/agents/39-ap-vendor-reconciliation-bill-com.md
# OR
rm .codex/agents/39-ap-vendor-reconciliation-bill-com.md
```
