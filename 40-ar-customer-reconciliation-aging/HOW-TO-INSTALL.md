# 40-ar-customer-reconciliation-aging — Codex Agent
...
cp 40-ar-customer-reconciliation-aging.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 40-ar-customer-reconciliation-aging.md
# OR
...
```bash
rm .codex/agents/40-ar-customer-reconciliation-aging.md
# OR
rm .codex/agents/40-ar-customer-reconciliation-aging.md
```
