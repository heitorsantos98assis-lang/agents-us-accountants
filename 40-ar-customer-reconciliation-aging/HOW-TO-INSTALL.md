# 40-ar-customer-reconciliation-aging — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `40-ar-customer-reconciliation-aging.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 40-ar-customer-reconciliation-aging.zip
```
...
cp 40-ar-customer-reconciliation-aging.md .claude/agents/
...
```
Use the ar-customer-reconciliation-aging subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 40-ar-customer-reconciliation-aging.md
# OR
...
```bash
rm .claude/agents/40-ar-customer-reconciliation-aging.md
# OR
rm ~/.claude/agents/40-ar-customer-reconciliation-aging.md
```
