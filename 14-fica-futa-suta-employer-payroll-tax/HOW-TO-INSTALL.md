# 14-fica-futa-suta-employer-payroll-tax — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `14-fica-futa-suta-employer-payroll-tax.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 14-fica-futa-suta-employer-payroll-tax.zip
```
...
cp 14-fica-futa-suta-employer-payroll-tax.md .claude/agents/
...
```
Use the fica-futa-suta-employer-payroll-tax subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 14-fica-futa-suta-employer-payroll-tax.md
# OR
...
```bash
rm .claude/agents/14-fica-futa-suta-employer-payroll-tax.md
# OR
rm ~/.claude/agents/14-fica-futa-suta-employer-payroll-tax.md
```
