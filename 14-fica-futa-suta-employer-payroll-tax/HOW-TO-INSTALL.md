# 14-fica-futa-suta-employer-payroll-tax — Codex Agent
...
cp 14-fica-futa-suta-employer-payroll-tax.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 14-fica-futa-suta-employer-payroll-tax.md
# OR
...
```bash
rm .codex/agents/14-fica-futa-suta-employer-payroll-tax.md
# OR
rm .codex/agents/14-fica-futa-suta-employer-payroll-tax.md
```
