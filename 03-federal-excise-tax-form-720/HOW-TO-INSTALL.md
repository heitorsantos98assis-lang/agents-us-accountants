# 03-federal-excise-tax-form-720 — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `03-federal-excise-tax-form-720.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 03-federal-excise-tax-form-720.zip
```
...
cp 03-federal-excise-tax-form-720.md .claude/agents/
...
```
Use the federal-excise-tax-form-720 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 03-federal-excise-tax-form-720.md
# OR
...
```bash
rm .claude/agents/03-federal-excise-tax-form-720.md
# OR
rm ~/.claude/agents/03-federal-excise-tax-form-720.md
```
