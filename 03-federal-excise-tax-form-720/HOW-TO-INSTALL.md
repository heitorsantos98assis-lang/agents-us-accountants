# 03-federal-excise-tax-form-720 — Codex Agent
...
cp 03-federal-excise-tax-form-720.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 03-federal-excise-tax-form-720.md
# OR
...
```bash
rm .codex/agents/03-federal-excise-tax-form-720.md
# OR
rm .codex/agents/03-federal-excise-tax-form-720.md
```
