# 38-merchant-processor-reconciliation-stripe-square — Codex Agent
...
cp 38-merchant-processor-reconciliation-stripe-square.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 38-merchant-processor-reconciliation-stripe-square.md
# OR
...
```bash
rm .codex/agents/38-merchant-processor-reconciliation-stripe-square.md
# OR
rm .codex/agents/38-merchant-processor-reconciliation-stripe-square.md
```
