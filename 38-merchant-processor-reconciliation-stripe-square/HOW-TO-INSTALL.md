# 38-merchant-processor-reconciliation-stripe-square — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `38-merchant-processor-reconciliation-stripe-square.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 38-merchant-processor-reconciliation-stripe-square.zip
```
...
cp 38-merchant-processor-reconciliation-stripe-square.md .claude/agents/
...
```
Use the merchant-processor-reconciliation-stripe-square subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 38-merchant-processor-reconciliation-stripe-square.md
# OR
...
```bash
rm .claude/agents/38-merchant-processor-reconciliation-stripe-square.md
# OR
rm ~/.claude/agents/38-merchant-processor-reconciliation-stripe-square.md
```
