# 18-management-pl-report-fathom-spotlight — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `18-management-pl-report-fathom-spotlight.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 18-management-pl-report-fathom-spotlight.zip
```
...
cp 18-management-pl-report-fathom-spotlight.md .claude/agents/
...
```
Use the management-pl-report-fathom-spotlight subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 18-management-pl-report-fathom-spotlight.md
# OR
...
```bash
rm .claude/agents/18-management-pl-report-fathom-spotlight.md
# OR
rm ~/.claude/agents/18-management-pl-report-fathom-spotlight.md
```
