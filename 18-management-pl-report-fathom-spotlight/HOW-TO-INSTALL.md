# 18-management-pl-report-fathom-spotlight — Codex Agent
...
cp 18-management-pl-report-fathom-spotlight.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 18-management-pl-report-fathom-spotlight.md
# OR
...
```bash
rm .codex/agents/18-management-pl-report-fathom-spotlight.md
# OR
rm .codex/agents/18-management-pl-report-fathom-spotlight.md
```
