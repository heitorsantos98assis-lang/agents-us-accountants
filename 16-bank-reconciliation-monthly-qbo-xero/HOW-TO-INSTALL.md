# 16-bank-reconciliation-monthly-qbo-xero — Codex Agent
...
cp 16-bank-reconciliation-monthly-qbo-xero.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 16-bank-reconciliation-monthly-qbo-xero.md
# OR
...
```bash
rm .codex/agents/16-bank-reconciliation-monthly-qbo-xero.md
# OR
rm .codex/agents/16-bank-reconciliation-monthly-qbo-xero.md
```
