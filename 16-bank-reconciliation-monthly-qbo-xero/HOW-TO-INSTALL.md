# 16-bank-reconciliation-monthly-qbo-xero — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `16-bank-reconciliation-monthly-qbo-xero.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 16-bank-reconciliation-monthly-qbo-xero.zip
```
...
cp 16-bank-reconciliation-monthly-qbo-xero.md .claude/agents/
...
```
Use the bank-reconciliation-monthly-qbo-xero subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 16-bank-reconciliation-monthly-qbo-xero.md
# OR
...
```bash
rm .claude/agents/16-bank-reconciliation-monthly-qbo-xero.md
# OR
rm ~/.claude/agents/16-bank-reconciliation-monthly-qbo-xero.md
```
