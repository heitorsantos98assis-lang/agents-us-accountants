# 53-entity-amendment-operating-agreement-bylaw-changes — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `53-entity-amendment-operating-agreement-bylaw-changes.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 53-entity-amendment-operating-agreement-bylaw-changes.zip
```
...
cp 53-entity-amendment-operating-agreement-bylaw-changes.md .claude/agents/
...
```
Use the entity-amendment-operating-agreement-bylaw-changes subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 53-entity-amendment-operating-agreement-bylaw-changes.md
# OR
...
```bash
rm .claude/agents/53-entity-amendment-operating-agreement-bylaw-changes.md
# OR
rm ~/.claude/agents/53-entity-amendment-operating-agreement-bylaw-changes.md
```
