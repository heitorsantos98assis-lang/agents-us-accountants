# 53-entity-amendment-operating-agreement-bylaw-changes — Codex Agent
...
cp 53-entity-amendment-operating-agreement-bylaw-changes.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 53-entity-amendment-operating-agreement-bylaw-changes.md
# OR
...
```bash
rm .codex/agents/53-entity-amendment-operating-agreement-bylaw-changes.md
# OR
rm .codex/agents/53-entity-amendment-operating-agreement-bylaw-changes.md
```
