# 09-form-1099-issuance-workflow — Codex Agent
...
cp 09-form-1099-issuance-workflow.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 09-form-1099-issuance-workflow.md
# OR
...
```bash
rm .codex/agents/09-form-1099-issuance-workflow.md
# OR
rm .codex/agents/09-form-1099-issuance-workflow.md
```
