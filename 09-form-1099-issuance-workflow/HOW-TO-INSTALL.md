# 09-form-1099-issuance-workflow — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `09-form-1099-issuance-workflow.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 09-form-1099-issuance-workflow.zip
```
...
cp 09-form-1099-issuance-workflow.md .claude/agents/
...
```
Use the form-1099-issuance-workflow subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 09-form-1099-issuance-workflow.md
# OR
...
```bash
rm .claude/agents/09-form-1099-issuance-workflow.md
# OR
rm ~/.claude/agents/09-form-1099-issuance-workflow.md
```
