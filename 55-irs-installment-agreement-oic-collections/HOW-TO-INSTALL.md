# 55-irs-installment-agreement-oic-collections — Codex Agent
...
cp 55-irs-installment-agreement-oic-collections.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 55-irs-installment-agreement-oic-collections.md
# OR
...
```bash
rm .codex/agents/55-irs-installment-agreement-oic-collections.md
# OR
rm .codex/agents/55-irs-installment-agreement-oic-collections.md
```
