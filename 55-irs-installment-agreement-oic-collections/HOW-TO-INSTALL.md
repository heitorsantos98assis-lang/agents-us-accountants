# 55-irs-installment-agreement-oic-collections — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `55-irs-installment-agreement-oic-collections.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 55-irs-installment-agreement-oic-collections.zip
```
...
cp 55-irs-installment-agreement-oic-collections.md .claude/agents/
...
```
Use the irs-installment-agreement-oic-collections subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 55-irs-installment-agreement-oic-collections.md
# OR
...
```bash
rm .claude/agents/55-irs-installment-agreement-oic-collections.md
# OR
rm ~/.claude/agents/55-irs-installment-agreement-oic-collections.md
```
