# 33-form-1099-s-1099-misc-real-estate-rentals — Codex Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `33-form-1099-s-1099-misc-real-estate-rentals.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 33-form-1099-s-1099-misc-real-estate-rentals.zip
```
...
cp 33-form-1099-s-1099-misc-real-estate-rentals.md .codex/agents/
...
```
Use the form-1099-s-1099-misc-real-estate-rentals subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 33-form-1099-s-1099-misc-real-estate-rentals.md
# OR
...
```bash
rm .codex/agents/33-form-1099-s-1099-misc-real-estate-rentals.md
# OR
rm .codex/agents/33-form-1099-s-1099-misc-real-estate-rentals.md
```
