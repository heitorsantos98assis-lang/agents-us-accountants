...
cp 33-form-1099-s-1099-misc-real-estate-rentals.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 33-form-1099-s-1099-misc-real-estate-rentals.md
# OR
...
```bash
rm .claude/agents/33-form-1099-s-1099-misc-real-estate-rentals.md
# OR
rm ~/.claude/agents/33-form-1099-s-1099-misc-real-estate-rentals.md
```
