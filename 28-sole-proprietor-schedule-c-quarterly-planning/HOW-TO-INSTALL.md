# 28-sole-proprietor-schedule-c-quarterly-planning — Codex Agent
...
cp 28-sole-proprietor-schedule-c-quarterly-planning.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 28-sole-proprietor-schedule-c-quarterly-planning.md
# OR
...
```bash
rm .codex/agents/28-sole-proprietor-schedule-c-quarterly-planning.md
# OR
rm .codex/agents/28-sole-proprietor-schedule-c-quarterly-planning.md
```
