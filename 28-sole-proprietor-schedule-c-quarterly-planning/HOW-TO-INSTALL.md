# 28-sole-proprietor-schedule-c-quarterly-planning — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `28-sole-proprietor-schedule-c-quarterly-planning.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 28-sole-proprietor-schedule-c-quarterly-planning.zip
```
...
cp 28-sole-proprietor-schedule-c-quarterly-planning.md .claude/agents/
...
```
Use the sole-proprietor-schedule-c-quarterly-planning subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 28-sole-proprietor-schedule-c-quarterly-planning.md
# OR
...
```bash
rm .claude/agents/28-sole-proprietor-schedule-c-quarterly-planning.md
# OR
rm ~/.claude/agents/28-sole-proprietor-schedule-c-quarterly-planning.md
```
