# 48-irs-business-notice-cp-response-1120-1065-1120s — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `48-irs-business-notice-cp-response-1120-1065-1120s.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 48-irs-business-notice-cp-response-1120-1065-1120s.zip
```
...
cp 48-irs-business-notice-cp-response-1120-1065-1120s.md .claude/agents/
...
```
Use the irs-business-notice-cp-response-1120-1065-1120s subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 48-irs-business-notice-cp-response-1120-1065-1120s.md
# OR
...
```bash
rm .claude/agents/48-irs-business-notice-cp-response-1120-1065-1120s.md
# OR
rm ~/.claude/agents/48-irs-business-notice-cp-response-1120-1065-1120s.md
```
