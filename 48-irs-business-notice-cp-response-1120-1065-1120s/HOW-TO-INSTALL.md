# 48-irs-business-notice-cp-response-1120-1065-1120s — Codex Agent
...
cp 48-irs-business-notice-cp-response-1120-1065-1120s.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 48-irs-business-notice-cp-response-1120-1065-1120s.md
# OR
...
```bash
rm .codex/agents/48-irs-business-notice-cp-response-1120-1065-1120s.md
# OR
rm .codex/agents/48-irs-business-notice-cp-response-1120-1065-1120s.md
```
