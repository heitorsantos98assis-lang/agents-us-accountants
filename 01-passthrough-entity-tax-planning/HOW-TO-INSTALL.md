# 01-passthrough-entity-tax-planning — Codex Agent
...
cp 01-passthrough-entity-tax-planning.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 01-passthrough-entity-tax-planning.md
# OR
...
```bash
rm .codex/agents/01-passthrough-entity-tax-planning.md
# OR
rm .codex/agents/01-passthrough-entity-tax-planning.md
```
