# 01-passthrough-entity-tax-planning — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `01-passthrough-entity-tax-planning.md` for the full description, frameworks, reference tables, and operating flow.
...
cp 01-passthrough-entity-tax-planning.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 01-passthrough-entity-tax-planning.md
# OR
...
```bash
rm .claude/agents/01-passthrough-entity-tax-planning.md
# OR
rm ~/.claude/agents/01-passthrough-entity-tax-planning.md
```
