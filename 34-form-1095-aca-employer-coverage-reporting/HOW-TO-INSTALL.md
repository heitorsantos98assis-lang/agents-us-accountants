...
cp 34-form-1095-aca-employer-coverage-reporting.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 34-form-1095-aca-employer-coverage-reporting.md
# OR
...
```bash
rm .claude/agents/34-form-1095-aca-employer-coverage-reporting.md
# OR
rm ~/.claude/agents/34-form-1095-aca-employer-coverage-reporting.md
```
