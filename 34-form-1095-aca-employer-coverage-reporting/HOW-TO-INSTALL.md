# 34-form-1095-aca-employer-coverage-reporting — Codex Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `34-form-1095-aca-employer-coverage-reporting.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 34-form-1095-aca-employer-coverage-reporting.zip
```
...
cp 34-form-1095-aca-employer-coverage-reporting.md .codex/agents/
...
```
Use the form-1095-aca-employer-coverage-reporting subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 34-form-1095-aca-employer-coverage-reporting.md
# OR
...
```bash
rm .codex/agents/34-form-1095-aca-employer-coverage-reporting.md
# OR
rm .codex/agents/34-form-1095-aca-employer-coverage-reporting.md
```
