# 36-us-gaap-chart-of-accounts-template — Codex Agent
...
cp 36-us-gaap-chart-of-accounts-template.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 36-us-gaap-chart-of-accounts-template.md
# OR
...
```bash
rm .codex/agents/36-us-gaap-chart-of-accounts-template.md
# OR
rm .codex/agents/36-us-gaap-chart-of-accounts-template.md
```
