# 36-us-gaap-chart-of-accounts-template — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `36-us-gaap-chart-of-accounts-template.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 36-us-gaap-chart-of-accounts-template.zip
```
...
cp 36-us-gaap-chart-of-accounts-template.md .claude/agents/
...
```
Use the us-gaap-chart-of-accounts-template subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 36-us-gaap-chart-of-accounts-template.md
# OR
...
```bash
rm .claude/agents/36-us-gaap-chart-of-accounts-template.md
# OR
rm ~/.claude/agents/36-us-gaap-chart-of-accounts-template.md
```
