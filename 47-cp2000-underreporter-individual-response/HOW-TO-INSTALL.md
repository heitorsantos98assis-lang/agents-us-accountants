# 47-cp2000-underreporter-individual-response — Codex Agent
...
cp 47-cp2000-underreporter-individual-response.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 47-cp2000-underreporter-individual-response.md
# OR
...
```bash
rm .codex/agents/47-cp2000-underreporter-individual-response.md
# OR
rm .codex/agents/47-cp2000-underreporter-individual-response.md
```
