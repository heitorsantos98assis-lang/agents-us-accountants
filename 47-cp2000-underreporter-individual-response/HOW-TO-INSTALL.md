# 47-cp2000-underreporter-individual-response — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `47-cp2000-underreporter-individual-response.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 47-cp2000-underreporter-individual-response.zip
```
...
cp 47-cp2000-underreporter-individual-response.md .claude/agents/
...
```
Use the cp2000-underreporter-individual-response subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 47-cp2000-underreporter-individual-response.md
# OR
...
```bash
rm .claude/agents/47-cp2000-underreporter-individual-response.md
# OR
rm ~/.claude/agents/47-cp2000-underreporter-individual-response.md
```
