# 50-smb-business-valuation-dcf-multiples-401k-esop — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `50-smb-business-valuation-dcf-multiples-401k-esop.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 50-smb-business-valuation-dcf-multiples-401k-esop.zip
```
...
cp 50-smb-business-valuation-dcf-multiples-401k-esop.md .claude/agents/
...
```
Use the smb-business-valuation-dcf-multiples-401k-esop subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 50-smb-business-valuation-dcf-multiples-401k-esop.md
# OR
...
```bash
rm .claude/agents/50-smb-business-valuation-dcf-multiples-401k-esop.md
# OR
rm ~/.claude/agents/50-smb-business-valuation-dcf-multiples-401k-esop.md
```
