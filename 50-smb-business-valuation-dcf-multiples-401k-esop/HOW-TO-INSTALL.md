# 50-smb-business-valuation-dcf-multiples-401k-esop — Codex Agent
...
cp 50-smb-business-valuation-dcf-multiples-401k-esop.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 50-smb-business-valuation-dcf-multiples-401k-esop.md
# OR
...
```bash
rm .codex/agents/50-smb-business-valuation-dcf-multiples-401k-esop.md
# OR
rm .codex/agents/50-smb-business-valuation-dcf-multiples-401k-esop.md
```
