# 24-invoice-bill-capture-hubdoc-dext-ramp — Codex Agent
...
cp 24-invoice-bill-capture-hubdoc-dext-ramp.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 24-invoice-bill-capture-hubdoc-dext-ramp.md
# OR
...
```bash
rm .codex/agents/24-invoice-bill-capture-hubdoc-dext-ramp.md
# OR
rm .codex/agents/24-invoice-bill-capture-hubdoc-dext-ramp.md
```
