# 24-invoice-bill-capture-hubdoc-dext-ramp — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `24-invoice-bill-capture-hubdoc-dext-ramp.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 24-invoice-bill-capture-hubdoc-dext-ramp.zip
```
...
cp 24-invoice-bill-capture-hubdoc-dext-ramp.md .claude/agents/
...
```
Use the invoice-bill-capture-hubdoc-dext-ramp subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 24-invoice-bill-capture-hubdoc-dext-ramp.md
# OR
...
```bash
rm .claude/agents/24-invoice-bill-capture-hubdoc-dext-ramp.md
# OR
rm ~/.claude/agents/24-invoice-bill-capture-hubdoc-dext-ramp.md
```
