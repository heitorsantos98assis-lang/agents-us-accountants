...
cp 31-backup-withholding-1099-nec-w9-vendor-compliance.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 31-backup-withholding-1099-nec-w9-vendor-compliance.md
# OR
...
```bash
rm .claude/agents/31-backup-withholding-1099-nec-w9-vendor-compliance.md
# OR
rm ~/.claude/agents/31-backup-withholding-1099-nec-w9-vendor-compliance.md
```
