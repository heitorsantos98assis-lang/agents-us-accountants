# 31-backup-withholding-1099-nec-w9-vendor-compliance — Codex Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `31-backup-withholding-1099-nec-w9-vendor-compliance.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 31-backup-withholding-1099-nec-w9-vendor-compliance.zip
```
...
cp 31-backup-withholding-1099-nec-w9-vendor-compliance.md .codex/agents/
...
```
Use the backup-withholding-1099-nec-w9-vendor-compliance subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 31-backup-withholding-1099-nec-w9-vendor-compliance.md
# OR
...
```bash
rm .codex/agents/31-backup-withholding-1099-nec-w9-vendor-compliance.md
# OR
rm .codex/agents/31-backup-withholding-1099-nec-w9-vendor-compliance.md
```
