# 06-sales-tax-return-multistate-filing — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (Bravy / ASV Digital).

## What this agent does

See `06-sales-tax-return-multistate-filing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 06-sales-tax-return-multistate-filing.zip
```
...
cp 06-sales-tax-return-multistate-filing.md .claude/agents/
...
```
Use the sales-tax-return-multistate-filing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 06-sales-tax-return-multistate-filing.md
# OR
...
```bash
rm .claude/agents/06-sales-tax-return-multistate-filing.md
# OR
rm ~/.claude/agents/06-sales-tax-return-multistate-filing.md
```
