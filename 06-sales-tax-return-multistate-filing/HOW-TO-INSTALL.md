# 06-sales-tax-return-multistate-filing — Codex Agent
...
cp 06-sales-tax-return-multistate-filing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 06-sales-tax-return-multistate-filing.md
# OR
...
```bash
rm .codex/agents/06-sales-tax-return-multistate-filing.md
# OR
rm .codex/agents/06-sales-tax-return-multistate-filing.md
```
