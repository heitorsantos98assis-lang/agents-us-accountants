# 45-erc-r-d-credit-fuel-credit-refund-claims — Codex Agent
...
cp 45-erc-r-d-credit-fuel-credit-refund-claims.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 45-erc-r-d-credit-fuel-credit-refund-claims.md
# OR
...
```bash
rm .codex/agents/45-erc-r-d-credit-fuel-credit-refund-claims.md
# OR
rm .codex/agents/45-erc-r-d-credit-fuel-credit-refund-claims.md
```
