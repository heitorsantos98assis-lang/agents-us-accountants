# 32-state-sales-tax-monthly-multistate-deep-dive — Codex Agent
...
cp 32-state-sales-tax-monthly-multistate-deep-dive.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 32-state-sales-tax-monthly-multistate-deep-dive.md
# OR
...
```bash
rm .codex/agents/32-state-sales-tax-monthly-multistate-deep-dive.md
# OR
rm .codex/agents/32-state-sales-tax-monthly-multistate-deep-dive.md
```
