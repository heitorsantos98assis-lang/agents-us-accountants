# 32-state-sales-tax-monthly-multistate-deep-dive — Claude Code Agent

A specialist subagent from the **57 Agents for US Accountants** bundle (HL).

## What this agent does

See `32-state-sales-tax-monthly-multistate-deep-dive.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 32-state-sales-tax-monthly-multistate-deep-dive.zip
```
...
cp 32-state-sales-tax-monthly-multistate-deep-dive.md .claude/agents/
...
```
Use the state-sales-tax-monthly-multistate-deep-dive subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 32-state-sales-tax-monthly-multistate-deep-dive.md
# OR
...
```bash
rm .claude/agents/32-state-sales-tax-monthly-multistate-deep-dive.md
# OR
rm ~/.claude/agents/32-state-sales-tax-monthly-multistate-deep-dive.md
```
